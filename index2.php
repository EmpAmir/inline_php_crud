...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">CCU-BOM</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index1.php">CCU-BLR</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">CCU-NDLS</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container py-3">
        <div class="row">
            <div class="col-12">
                <h3 class="text-center">CCU TO NDLS</h3>
            </div>
            <hr>
            <div class="col-12">
                <!-- Table Form start -->
                <form action="" id="form-data">
                    ...
                    <table class='table table-hovered table-stripped table-bordered' id="form-tbl">
                        ...
                        <tbody>
                            ...
                            <?php
                            $query = $conn->query("SELECT * FROM `members2` order by id asc");
